...
visualisationCount = pyLDAvis.sklearn.prepare(lda_tf, dtm_tf, tf_vectorizer)
pyLDAvis.save_html(visualisationCount, os.path.join(dirname, 'output/LDA_Visualization_CountVectorizer.html'))

visualisationIdf = pyLDAvis.sklearn.prepare(lda_tfidf, dtm_tfidf, tfidf_vectorizer)
pyLDAvis.save_html(visualisationIdf, os.path.join(dirname, 'output/LDA_Visualization_TfidfVectorizer.html'))
